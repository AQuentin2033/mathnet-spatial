namespace MathNet.Spatial.Internals
{
    ...
    internal class QuadrantSpecific1 : Quadrant
    {
        ...
        internal QuadrantSpecific1(Point2D[] listOfPoint, Func<Point2D, Point2D, int> comparer)
        ...
        protected override void SetQuadrantLimits()
        {
            ...
            this.FirstPoint = new Point2D(rightX, rightY);
            this.LastPoint = new Point2D(topX, topY);
            this.RootPoint = new Point2D(topX, rightY);
        }
