namespace MathNet.Spatial.Internals
{
    ...
    internal class QuadrantSpecific4 : Quadrant
    {
        ...
        internal QuadrantSpecific4(Point2D[] listOfPoint, Func<Point2D, Point2D, int> comparer)
        ...
        protected override void SetQuadrantLimits()
        {
            ...
            this.FirstPoint = new Point2D(bottomX, bottomY);
            this.LastPoint = new Point2D(rightX, rightY);
            this.RootPoint = new Point2D(bottomX, rightY);
        }
