namespace MathNet.Spatial.Internals
{
    ...
    internal class QuadrantSpecific2 : Quadrant
    {
        ...
        internal QuadrantSpecific2(Point2D[] listOfPoint, Func<Point2D, Point2D, int> comparer)
        ...
        protected override void SetQuadrantLimits()
        {
            ...
            this.FirstPoint = new Point2D(topX, topY);
            this.LastPoint = new Point2D(leftX, leftY);
            this.RootPoint = new Point2D(topX, leftY);
        }
